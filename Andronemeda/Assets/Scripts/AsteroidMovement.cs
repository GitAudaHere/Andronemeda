...
public class AsteroidMovement : MonoBehaviour {
	...
	/// <summary>
	/// 	The asteroid. Used for spawning new asteroids when big asteroids break apart.
	/// </summary>
	...
	private void DestroyBigAsteroid()
	{
		...
		int randAsteroidPieces = Random.Range (minAsteroidPieces, maxAsteroidPieces + 1); // Accounts for an exclusive
																						  // maximum value

		for (int i = 0; i < randAsteroidPieces; i++)
		{
			Instantiate (asteroid, GetComponent<Rigidbody2D>().position, Quaternion.identity);
		}
	}
}
